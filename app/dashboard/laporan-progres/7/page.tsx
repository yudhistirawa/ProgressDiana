...
export const metadata = {
  title: "Laporan Tahap 7 - Sistem Dokumentasi Progres",
  description: "Formulir pengisian laporan progres tahap 7",
};

export default function LaporanTahapTujuh() {
  return (
      ...
      <header className="sticky top-0 z-20 bg-white/95 backdrop-blur supports-[backdrop-filter]:bg-white/80 border-b border-neutral-200 shadow-sm">
        <div className="mx-auto max-w-2xl sm:max-w-3xl px-3 sm:px-4 py-3 flex items-center justify-between">
          <ConfirmNavigationButton
            ...
            draftStorageKey={formStorageKey(7)}
            unsavedSessionKey={unsavedFlagKey(7)}
          ...
          <div className="text-sm sm:text-base font-semibold tracking-wide">Laporan Tahap 7</div>
