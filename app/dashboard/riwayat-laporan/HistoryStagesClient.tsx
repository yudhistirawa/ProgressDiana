  ...
  return (
    <section className="grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4">
      {items.map((stage, idx) => (
        ...
        >
          <div
            className="mx-auto mb-3 sm:mb-4 h-16 w-16 sm:h-20 sm:w-20 rounded-xl grid place-items-center bg-gradient-to-br from-slate-50 to-slate-100 ring-1 ring-neutral-200 text-neutral-800 group-hover:scale-105 transition-transform"
            aria-hidden
          >
            {idx % 2 === 0 ? (
