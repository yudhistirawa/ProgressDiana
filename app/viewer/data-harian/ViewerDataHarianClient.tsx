...
export default function ViewerDataHarianClient() {
  ...
  return (
    ...
    <div className="bg-neutral-50 h-[calc(100vh-90px)] p-4 sm:p-6 overflow-y-auto">
      {/* Summary Cards & Filters */}
      <div className="rounded-2xl ring-1 ring-neutral-200 bg-white p-6 space-y-6 mb-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="rounded-xl bg-gradient-to-br from-blue-100 to-white p-4 ring-1 ring-blue-200">
          ...
          <div className="rounded-xl bg-gradient-to-br from-green-100 to-white p-4 ring-1 ring-green-200">
          ...
          <div className="col-span-1 sm:col-span-2 rounded-xl bg-neutral-100/60 p-4 ring-1 ring-neutral-200 flex items-center justify-center">
            <p className="text-sm text-neutral-600 text-center">
              Menampilkan data periode: <br />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-4 border-t border-neutral-200">
          <div>
            <label className="block text-xs font-medium text-neutral-600 mb-1">Tahun</label>
            <select value={filterYear} onChange={(e) => setFilterYear(e.target.value)} className="w-full rounded-lg border-neutral-300 shadow-sm text-sm focus:border-red-500 focus:ring-red-500">
          ...
          <div>
            <label className="block text-xs font-medium text-neutral-600 mb-1">Bulan</label>
            <select value={filterMonth} onChange={(e) => setFilterMonth(e.target.value)} className="w-full rounded-lg border-neutral-300 shadow-sm text-sm focus:border-red-500 focus:ring-red-500">
          ...
          <div className="flex items-end">
            <button onClick={loadDailyData} disabled={loading} className="w-full inline-flex justify-center items-center gap-2 rounded-lg bg-red-600 text-white px-4 py-2 text-sm font-semibold hover:bg-red-700 transition-all disabled:bg-neutral-400 disabled:cursor-wait">
              Refresh Data
            </button>
          </div>
        </div>
              ...
              <table className="w-full text-sm table-fixed">
                ...
                <tbody className="divide-y divide-neutral-200">
                  {dailyStats.map((day) => {
                    ...
                    return (
                    <tr key={day.tanggal} className="even:bg-neutral-50/50 hover:bg-red-50/50 transition-colors">
                        ...
                        <td className="px-4 py-3 text-center">
                        <button onClick={() => handleDateClick(day.tanggal, day.items)} className="inline-flex items-center gap-1 rounded-lg bg-white hover:bg-neutral-100 px-3 py-1.5 text-xs font-medium transition-colors ring-1 ring-neutral-300 shadow-sm">
      ...
      {/* Modal Detail */}
      {selectedDate && (
        <div className="fixed inset-0 z-50 flex items-start justify-center bg-black/60 p-4 backdrop-blur-sm" onClick={closeModal}>
