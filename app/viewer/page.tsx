...
const FEATURE_CARDS = [
  ...
  {
    href: "/viewer/planning",
    title: "Planning",
    desc: "Lihat target harian dan progres real (dengan bukti foto) sebagai acuan pekerjaan.",
    ...
    accent: "from-emerald-50/70 to-white border-emerald-100 hover:border-emerald-200 shadow-emerald-100/60",
  },
];
